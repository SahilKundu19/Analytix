...
const Hero = () => {
    ...
    const scrollYTransfrom = useTransform(scrollYProgress, [0, 1], [0.85, 1.15]);

    const scale = useSpring(scrollYTransfrom, {
        stiffness: 300,
        damping: 30,
        restDelta: 0.001,
    })
      ...
      >
        <div className='max-w-screen-md mx-auto'>
          <motion.p
            ...
            className='text-sm uppercase tracking-wider bg-secondary/90 text-secondary-foreground max-w-max mx-auto px-3 py-1.5 rounded-full border-t border-b border-blue-500/50 backdrop-blur-3xl mb-6 md:mb-10'
          >
